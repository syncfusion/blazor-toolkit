...
namespace Syncfusion.Blazor.Toolkit.Inputs
{
    ...
    public partial class SfTextArea : SfInputBase<string>
    {
        ...
        /// rendered textarea. The <c>err_&lt;ID&gt;</c> token is a deterministic id the consumer
        ...
        /// <c>err_</c> token previously appended to <c>aria-describedby</c> is preserved verbatim
        /// (a user-supplied <see cref="AriaDescribedBy"/> is never overwritten).
        /// </remarks>
        private void SyncInvalidAriaState()
        {
            ...
            else
            {
                ...
                // the rendered textarea; UpdateDictionary would write the key
                // back as null.
