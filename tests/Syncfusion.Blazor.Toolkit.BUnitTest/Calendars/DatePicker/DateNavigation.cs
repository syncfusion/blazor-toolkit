...
namespace Syncfusion.Blazor.Toolkit.Tests.Calendars.DatePicker
{
    public class DateNavigation : BunitTestContext
    {
        ...
        public async Task CurrentMonthToNextMonthNavigation()
        {
            ...
            // buttonList[0]=date icon, buttonList[1]=title, buttonList[2]=prev, buttonList[3]=next, buttonList[4]=today
            Assert.Contains("e-prev", buttonList[2].ClassName);
            Assert.Contains("e-disabled", buttonList[2].ClassName);
