...
namespace Syncfusion.Blazor.Toolkit.Tests.Inputs.TextBox
{
    public class TextBox : BunitTestContext
    {
        ...
        public void RoleAttribute()
        {
            ...
            // Native <input type="text"> and <textarea> already carry implicit, well-supported roles
            // (textbox and textbox respectively) without an explicit role attribute. The redundant
