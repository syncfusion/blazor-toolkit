...
{
    public class OutlinedTextBox : BunitTestContext
    {
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline"));
        ...
        public void DefaultValue()
        {
            ...
            Assert.Contains("e-outline", textBox.Instance.CssClass);
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameters => parameters.Add(p => p.CssClass, "e-outline"));
            var inputElement = textBox.Find("input");
            var containerElement = inputElement.ParentElement;
            Assert.NotNull(containerElement);
            Assert.Contains("e-outline", containerElement.ClassName);
            ...
            Assert.DoesNotContain("e-outline", containerElement.ClassName);
        }

        [Fact(Timeout = 10000)]
        public void TabIndex()
        {
            var textBox = RenderComponent<SfTextBox>(parameters => parameters.Add(p => p.CssClass, "e-outline").Add(p => p.TabIndex, 1));
            var inputElement = textBox.Find("input");
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.ReadOnly, true));
            var inputElement = textBox.Find("input");
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Width, "300px"));
            var inputElement = textBox.Find("input");
            var containerElement = inputElement.ParentElement;
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Placeholder, "Enter the value"));
            var inputElement = textBox.Find("input");
        ...
        public void Enabled()
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Disabled, false));
            var inputElement = textBox.Find("input");
            var containerElement = inputElement.ParentElement;
            Assert.NotNull(containerElement);
        ...
        public void HtmlAttributes()
        {
            ...
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.HtmlAttributes, htmlAttributes));
            var inputElement = textBox.Find("input");
            var containerElement = inputElement.ParentElement;
            Assert.NotNull(containerElement);
        ...
        public void InputAttributes()
        {
            ...
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.InputAttributes, inputAttributes).Add(p => p.CssClass, "e-outline"));
            var inputElement = textBox.Find("input");
            var containerElement = inputElement.ParentElement;
            Assert.Contains("textbox", inputElement.GetAttribute("name"));
            Assert.Contains("true", inputElement.GetAttribute("required"));
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.ShowClearButton, true));
            var inputElement = textBox.Find("input");
            var containerElement = inputElement.ParentElement;
            Assert.NotNull(containerElement);
            var clearIconElement = containerElement.Children[1];
            // Native <input type="text"> and <textarea> already carry implicit textbox roles.
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline e-static-clear").Add(p => p.ShowClearButton, true));
            var inputElement = textBox.Find("input");
            var containerElement = inputElement.ParentElement;
            Assert.NotNull(containerElement);
            var clearIconElement = containerElement.Children[1];
        ...
        public void FloatingLabel()
        {
            ...
            Assert.NotNull(floatLabelElement);
            Assert.Contains("e-label-top", floatLabelElement.ClassName);
            textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Placeholder, "Enter the value").Add(p => p.FloatLabelType, FloatLabelType.Always));
            inputElement = textBox.Find("input");
            inputElement.Focus();
            containerElement = inputElement.ParentElement;
            Assert.NotNull(containerElement);
            ...
            Assert.NotNull(floatLabelElement);
            Assert.Contains("e-label-top", floatLabelElement.ClassName);
            textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Placeholder, "Enter the value").Add(p => p.FloatLabelType, FloatLabelType.Never));
            inputElement = textBox.Find("input");
            containerElement = inputElement.ParentElement;
            Assert.NotNull(containerElement);
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Value, "Test"));
        ...
        {
            var textBox = RenderComponent<SfTextBox>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Type, InputType.Email));
            var inputElement = textBox.Find("input");
            Assert.Equal("email", inputElement.GetAttribute("type"));
