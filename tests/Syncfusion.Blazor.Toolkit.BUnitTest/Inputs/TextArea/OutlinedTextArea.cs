...
{
    public class OutlinedTextArea : BunitTestContext
    {
        [Fact(Timeout = 10000, DisplayName = "Outlined - Default Properties Initialization")]
        public void DefaultInitialize()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p=> p.CssClass, "e-outline"));
        ...
        public void DefaultParams()
        {
            ...
            Assert.Contains("e-outline",textArea.Instance.CssClass);
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - CssClass Property")]
        public void CssClass()
        {
            var textArea = RenderComponent<SfTextArea>(parameters => parameters.Add(p=> p.CssClass, "e-outline"));
            var containerEle = textArea.Find("textarea").ParentElement;
            Assert.NotNull(containerEle);
            Assert.Contains("e-outline", containerEle.ClassName);
            ...
            Assert.DoesNotContain("e-outline", containerEle.ClassName);
        }
        [Fact(Timeout = 10000, DisplayName = "Outlined - TabIndex Property")]
        public void TabIndex()
        {
            var textArea = RenderComponent<SfTextArea>(parameters => parameters.Add(p=> p.CssClass, "e-outline").Add(p => p.TabIndex, 1));
            var textAreaEle = textArea.Find("textarea");
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - ReadOnly Property")]
        public void ReadOnly()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.ReadOnly, true));
            var textAreaEle = textArea.Find("textarea");
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Resize Mode")]
        public void ResizeMode()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.ResizeMode, Resize.Vertical));
            var textAreaEle = textArea.Find("textarea");
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - MaxLength Property")]
        public void MaxLength()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.MaxLength, 10));
            var textAreaEle = textArea.Find("textarea");
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Row and Column")]
        public void RowAndColumn()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.RowCount, 3).Add(p => p.ColumnCount, 25));
            var textAreaEle = textArea.Find("textarea");
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Width Change")]
        public void WidthChange()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p=> p.CssClass, "e-outline").Add(p => p.Width, "300px"));
            var textAreaEle = textArea.Find("textarea");
            ...
            textArea.SetParametersAndRender(("ResizeMode", Resize.Vertical));
            textAreaEle = textArea.Find("textarea");
            containerEle = textAreaEle.ParentElement;
            Assert.Contains("width: 600px", containerEle.GetStyle().CssText.Trim());
            Assert.Contains("e-resize-y", textAreaEle.ClassName);
        }
        [Fact(Timeout = 10000, DisplayName = "Outlined - Placeholder")]
        public void Placeholder()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p=> p.CssClass, "e-outline").Add(p => p.Placeholder, "Enter the value"));
            var textAreaEle = textArea.Find("textarea");
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Disabled State")]
        public void Disabled()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p=> p.CssClass, "e-outline").Add(p => p.Disabled, false).Add(p => p.ResizeMode, Resize.Horizontal));
            var textAreaEle = textArea.Find("textarea");
            var containerEle = textAreaEle.ParentElement;
            Assert.NotNull(containerEle);
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - HtmlAttributes")]
        public void HtmlAttributes()
        {
            ...
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p=> p.CssClass, "e-outline").Add(p => p.HtmlAttributes, htmlAttributes));
            var textAreaEle = textArea.Find("textarea");
            var containerEle = textAreaEle.ParentElement;
            Assert.NotNull(containerEle);
            ...
            textArea.SetParametersAndRender(("HtmlAttributes", new Dictionary<string, object>() { { "maxlength", 10 }}));
            textAreaEle = textArea.Find("textarea");
            containerEle = textAreaEle.ParentElement;
            Assert.Equal("10", textAreaEle.GetAttribute("maxlength"));
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Clears value using clear button")]
        public void ClearButton()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p=> p.CssClass, "e-outline").Add(p => p.ShowClearButton, true));
            var containerEle = textArea.Find("textarea").ParentElement;
            Assert.NotNull(containerEle);
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Float label Updates")]
        public void FloatingLabel()
        {
            ...
            Assert.NotNull(floatEle);
            Assert.Contains("e-label-top", floatEle.ClassName);
            textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Placeholder, "Enter the value").Add(p => p.FloatLabelType, FloatLabelType.Always));
            textAreaEle = textArea.Find("textarea");
            textAreaEle.Focus();
            containerEle = textArea.Find("textarea").ParentElement;
            Assert.NotNull(containerEle);
            ...
            Assert.NotNull(floatEle);
            Assert.Contains("e-label-top", floatEle.ClassName);
            textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.CssClass, "e-outline").Add(p => p.Placeholder, "Enter the value").Add(p => p.FloatLabelType, FloatLabelType.Never));
            containerEle = textArea.Find("textarea").ParentElement;
            Assert.NotNull(containerEle);
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Sets focus state on input")]
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Value Binding")]
        public void ValueBinding()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p=> p.CssClass, "e-outline").Add(p => p.Value, "Test"));
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Clears value using static clear icon")]
        public void StaticClearIcon()
        {
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.CssClass, "e-outline e-static-clear").Add(p => p.ShowClearButton, true));
            var containerEle = textArea.Find("textarea").ParentElement;
            Assert.NotNull(containerEle);
        ...
        [Fact(Timeout = 10000, DisplayName = "Outlined - Renders all the Properties")]
        public void AllPropertiesRender()
        {
            Dictionary<string, object> htmlAttributes = new Dictionary<string, object>() { { "class", "e-text" } };
            var textArea = RenderComponent<SfTextArea>(parameter => parameter.Add(p => p.ID, "Text-1").Add(p => p.ResizeMode, Resize.Horizontal).Add(p => p.CssClass, "e-outline e-test").Add(p => p.ReadOnly, false).Add(p => p.Disabled, false).Add(p => p.EnablePersistence, true).Add(p => p.Placeholder, "Enter the value").Add(p => p.FloatLabelType, FloatLabelType.Always).Add(p => p.HtmlAttributes, htmlAttributes).Add(p => p.ShowClearButton, true).Add(p => p.Value, "Test").Add(p => p.Width, "600px").Add(p => p.TabIndex, 1).Add(p => p.MaxLength, 20).Add(p => p.RowCount, 4).Add(p => p.ColumnCount, 28));
            var textAreaEle = textArea.Find("textarea");
            var containerEle = textAreaEle.ParentElement;
            Assert.NotNull(containerEle);
